        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/performance" && "text-white"
                              }`}
                            >
                              Overview
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/performance/profitability"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/performance/profitability" &&
                                "text-white"
                              }`}
                            >
                              Profitability
              ...
              {["facebook", "google", "twitter", "linkedin", "instagram"].map(
                (val) => (
                  <SidebarLinkGroup
                    key={val}
                    activeCondition={
                      pathname === `/${val}` || pathname.includes(val)
                    }
                  >
                    {(handleClick, open) => {
                      return (
                        <React.Fragment>
                          <Link
                            href="#"
                            className={`text-capitalize group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                              (pathname === `/${val}` ||
